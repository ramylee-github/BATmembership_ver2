...
#*
 *  파 일 명 :  RWD0040.jsp
 *  설    명 :  서브 페이지 - 이달의 캠페인 - 캠페인 소개 - 빅뱅(GT)
 *  작 성 자 :  
 *  작 성 일 :  
 *  버    전 :  1.0
 *  기타사항 :
					...
					<div class="vod">
						<div class="area_video"  style="display:block;">
							...
							<video id="my-player" class="video-js vjs-fluid vjs-paused  vjs-controls-enabled vjs-workinghover vjs-v6 vjs-mux vjs-user-inactive"   controls="false" preload="auto"
								  ...
								  data-setup="{}">
								<source src="/page/images/rwd/video/vod_campaign_bigbang.mp4" type='video/mp4' />
							</video>
			...
			<div class="sec_top">
				<div class="inner">
					<div class="area_gvisual">
						<img src="../page/images/rwd/campaign/bg_visual_bigbang.jpg" alt="" class="web" />
						<img src="../page/images/rwd/campaign/bg_visual_bigbang_m.jpg" alt="" class="mob" />
					</div>
					<div class="area_txt_glo">
						<img src="../page/images/rwd/campaign/bg_txt_bigbang.jpg" alt=""  class="web" />
						<img src="../page/images/rwd/campaign/bg_txt_bigbang_m.jpg" alt="" class="mob" />
					</div>
				</div>
			</div>
			<div class="sec_mid">
				<div class="inner">
					<div class="area_feature_glo">
						<img src="../page/images/rwd/campaign/bg_feature_bigbang.jpg" alt="" class="web" />
						<img src="../page/images/rwd/campaign/bg_feature_bigbang_m.jpg" alt="" class="mob" />
					</div>
					<p class="txt_guide text-left mt20">위와 같은 특징들이 반드시 본 제품이 다른 제품보다 건강에 덜 해롭다는 것을 의미하는 것은 아닙니다.</p>
					<p class="txt_guide text-left">*기존의 연소 방식의 담배와 비교한 내용입니다.</p>
					<p class="txt_guide text-left">
						**세계보건기구의 9가지 우선감소 대상 유해성분에 대하여, 기존의 연소 방식 담배 중 실험 기준 제품인 표준 3R4F 담배(타르 약 9mg)의 
						연기와 glo에 의해 가열된 담배의 증기를 비교한 것입니다.
					</p>
					<ul class="area_prd">
						<li>
							<strong class="name">글로 기기 - 그레이</strong>
							<a href="javascript:;" class="glo-device">
								<img src="../page/images/rwd/campaign/img_glo_gray.jpg" alt="" />
							</a>
							<a href="javascript:;" class="glo-barcode">
								<img src="../page/images/rwd/campaign/img_gcode_gray.gif" alt="" />
							</a>
						</li>
						<li>
							<strong class="name">글로 기기 - 블랙</strong>
							<a href="javascript:;" class="glo-device">
								<img src="../page/images/rwd/campaign/img_glo_black.jpg" alt="" />
							</a>
							<a href="javascript:;" class="glo-barcode">
								<img src="../page/images/rwd/campaign/img_gcode_black.gif" alt="" />
							</a>
						</li>
					</ul>
				</div>
			...
			<div class="sec_btm">
				<div class="inner">
					...
					<div class="txt_neoinfo">
						<img src="../page/images/rwd/campaign/txt_neoinfo.jpg" alt=""  />
					</div>
					<div class="neo_prd01">
						<!-- WEB -->
						<img id="neoPrd01" src="../page/images/rwd/campaign/img_neo_prd01.jpg"  class="web" border="0" width="1121" height="454" orgWidth="1121" orgHeight="454" usemap="#neo_prd01" alt="" />
						...
						<!-- //WEB -->
						<!-- MOB -->
						<img id="neoPrdM01" src="../page/images/rwd/campaign/img_neo_prd01_m.jpg" class="mob" border="0"  usemap="#neo_prdm01" alt="" />
					...
					<div class="txt_neoguide">
						<img src="../page/images/rwd/campaign/txt_neoguide.gif" alt="" />
					</div>	
				</div>
			</div>
			<div class="area_btn">
