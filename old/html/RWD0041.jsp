...
#*
 *  파 일 명 :  RWD0041.jsp
 *  설    명 :  서브 페이지 - 이달의 캠페인 - 캠페인 소개 - 빅뱅(KA)
 *  작 성 자 :  
 *  작 성 일 :  
 *  버    전 :  1.0
 *  기타사항 :
		...
		<div class="content camp_bigbang" style="padding:0; max-width:none;">
					...
					<div class="vod">
						<div class="area_video"  style="display:block;">
							...
							<video id="my-player" class="video-js vjs-fluid vjs-paused  vjs-controls-enabled vjs-workinghover vjs-v6 vjs-mux vjs-user-inactive"   controls="false" preload="auto"
								  poster="/page/images/rwd/campaign/img_poster_bigbang.jpg"
								  autoplay loop muted playsinline
								  data-setup="{}">
								<source src="/page/images/rwd/video/vod_campaign_bigbang_part2.mp4" type='video/mp4' />
							</video>
			...
			<div class="sec_mid">
				<div class="inner">
					...
					<p class="txt_guide text-left">위와 같은 특징들이 반드시 본 제품이 다른 제품보다 건강에 덜 해롭다는 것을 의미하는 것은 아닙니다.</p>
			...
			<div class="sec_btm">
				<div class="inner">
					...
					<div class="txt_neoinfo">
						<img src="../page/images/rwd/campaign/txt_neoinfo_ka.jpg" alt=""  />
					</div>
					<div class="neo_prd01">
						<!-- WEB -->
